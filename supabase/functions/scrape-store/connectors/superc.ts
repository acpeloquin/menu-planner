...
export const scrapeSuperC: VisionFlyerConnector = {
  kind: 'vision-flyer',
  fetchFlyer: () => fetchCirculairesFlyerPages('superc'),
  extractDeals: (images, validFrom, validTo) => extractDealsFromFlyerImages(images, 'Super C', validFrom, validTo),
};
