...
export const RECIPE_SEARCH_TOOLS_MENU = [
  { type: 'web_search_20260209', name: 'web_search', allowed_domains: ALLOWED_RECIPE_DOMAINS, max_uses: 4 },
  { type: 'web_fetch_20260209', name: 'web_fetch', allowed_domains: ALLOWED_RECIPE_DOMAINS, max_uses: 2 },
];
